...
public class CategoriaDAOImplementar implements CategoriaDAO{
    ...
    public Categoria editarCat(int id_cat_edit) {
     ...
     public String NombreCategoria(int id_cat_edit) {
        this.conn = FactoryConexionDB.open(FactoryConexionDB.MySQL);
        Categoria categoria = new Categoria();
        StringBuilder miSQL = new StringBuilder();
        String valor = "---";
       miSQL.append("SELECT * FROM tb_categoria WHERE id_categoria = ").append(id_cat_edit);
        try {
            ...
            while (resultadoSQL.next()) {
               ...
               valor = resultadoSQL.getString("num_categoria");
    ...
    public boolean guardarCat(Categoria categoria) {
        ...
        try {
            if(categoria.getId_categoria() == 0){
                ...
                miSQL.append("UPDATE tb_categoria SET num_categoria = '").append(categoria.getNom_categoria());
