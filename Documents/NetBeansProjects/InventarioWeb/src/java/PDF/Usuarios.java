...
response.setContentType("application/pdf");
        ...
        try{
            ...
            try{
                ...
                rst = st.executeQuery("SELECT * FROM tb_usuario; ");
              ...
              par1.add(new Phrase("Listado de Categorias", fontitulo));
              ...
              par2.add(new Phrase("Usuarios almacenados.", fondescrip));
              ...
              PdfPCell celda5 = new PdfPCell (new Paragraph("usuario", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda6 = new PdfPCell (new Paragraph("clave", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda7 = new PdfPCell (new Paragraph("tipo", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda8 = new PdfPCell (new Paragraph("esatdo", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda9 = new PdfPCell (new Paragraph("pregunta", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda10 = new PdfPCell (new Paragraph("respuesta", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              PdfPCell celda11 = new PdfPCell (new Paragraph("fecha_registro", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.BLACK)));
              ...
              while (rst.next()){
                  ...
                  tabla.addCell(rst.getString(10));
                  tabla.addCell(rst.getString(11));
              }
              documento.add(tabla);
